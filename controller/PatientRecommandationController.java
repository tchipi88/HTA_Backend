...
/**
 * REST controller for managing PatientRecommandation.
 */
@RestController
@RequestMapping("/api")
public class PatientRecommandationController {
    ...
    public ResponseEntity<PatientRecommandation> createPatientRecommandation(@Valid @RequestBody PatientRecommandation patientrecommandation) throws URISyntaxException {
        ...
        PatientRecommandation result = patientrecommandationRepository.save(patientrecommandation);
    ...
    public ResponseEntity<PatientRecommandation> updatePatientRecommandation(@Valid @RequestBody PatientRecommandation patientrecommandation) throws URISyntaxException {
    ...
    public List<PatientRecommandation> getAllPatientRecommandations() {
        log.debug("REST request to get all PatientRecommandations");
        List<PatientRecommandation> patientrecommandations = patientrecommandationRepository.findAll();
    ...
    public ResponseEntity<PatientRecommandation> getPatientRecommandation(@PathVariable Long id) {
        log.debug("REST request to get PatientRecommandation : {}", id);
        PatientRecommandation patientrecommandation = patientrecommandationRepository.findOne(id);
