...
public class ChwResource {
    ...
    private final Logger log = LoggerFactory.getLogger(ChwResource.class);
    ...
    @PostMapping("/chws")
    @Timed
    public ResponseEntity<Chw> createChw(@Valid @RequestBody Chw chw) throws Exception {
    ...
    @PutMapping("/chws")
    @Timed
    public ResponseEntity<Chw> updateChw(@Valid @RequestBody Chw chw) throws Exception {
