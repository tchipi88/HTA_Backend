...
public class MedecinResource {
    ...
    @Timed
    public ResponseEntity<Medecin> createMedecin(@Valid @RequestBody Medecin medecin) throws Exception {
    ...
    @PutMapping("/medecins")
    @Timed
    public ResponseEntity<Medecin> updateMedecin(@Valid @RequestBody Medecin medecin) throws Exception {
