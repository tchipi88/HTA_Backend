...
public class PatientBilanResource {
    ...
    public PatientBilanResource(PatientBilanRepository patientBilanRepository) {
     ...
     * @return the ResponseEntity with status 201 (Created) and with body the new patientBilan, or with status 400 (Bad Request) if the patientBilan has already an ID
     ...
     * @return the ResponseEntity with status 200 (OK) and with body the updated patientBilan,
     * or with status 400 (Bad Request) if the patientBilan is not valid,
     * or with status 500 (Internal Server Error) if the patientBilan couldnt be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
     ...
     *
     * @return the ResponseEntity with status 200 (OK) and the list of patientBilans in body
     */
     ...
     * @return the ResponseEntity with status 200 (OK) and with body the patientBilan, or with status 404 (Not Found)
     */
